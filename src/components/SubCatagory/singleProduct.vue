                    ...
                    <div class="card">
                        <div class="card-body p-5 ">
                            ...
                            <div class=" d-flex justify-content-center">
                                <div class="details  ">
                                    <div>
                                        <img :src="items.product_img" class="img-fluid ms-3 mb-5" width="300"
                                            height="150" />
                                    </div>
                                    <div>
                                        ...
                                        <b class="ms-3 text-nowrap ">ProductDescription:</b>{{
                                        ...
                                        <div class="cart ms-3 d-flex ">
                                            ...
                                            <button class="btn btn-outline-primary text-nowrap" v-on:click="addToCart">
                                                Add to Cart</button>

                                            <button class="btn btn-outline-warning  ms-2"
                                                v-on:click="decrement(items.id)"><i
                                                    class="fa fa-minus fa-lg"></i></button>
                                            <button class="btn btn-outline-success  ms-2"
                                                v-on:click="increment(items.id)"><i
                        ...
                        <div class="d-flex justify-content-center mt-3 mt-3">
                            ...
                            <router-link v-if="moveToCart()" to="/Cart"><button class="btn btn-outline-primary ms-3">GoToCart
                                    --></button>
                            </router-link>
